...
import NiceColorPalette from "nice-color-palettes/200.json";
import { OrbitControls } from "three/examples/jsm/controls/OrbitControls";

import GrassMaterial from "../../assets/glsl/grass/index.js";
import FloorMaterial from "../../assets/glsl/floor/index.js";
import ParticleMaterial from "../../assets/glsl/particles/index.js";
import getPos from "../utils/getPosition.utils.js";
import pick from "../utils/randomFromArray.utils.js";

const debug = false;
const delta = 1 / 60;
const height = 0.3;

const pal = NiceColorPalette[129];

const BG = new Color(pal[0]);
const wispColor = new Color("white");
...
class Environment {
  ...
  createScene() {
    const { W, H, PR } = window.dimensions;
    const fov = 50;
  ...
  onPointerUp(e) {
    ...
    gsap.to(container, {
      ...
      overwrite: true,
      onUpdate: () => {
        this.grass.material.uniforms.wave.value =
          Math.sin(container.value) * 0.4;
      },
    });
